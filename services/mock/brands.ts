...
export const mockBrands: Brand[] = [
  {
    id: "1",
    title: "TechFlow Media",
    description:
      "Premium tech and innovation ad inventory across leading tech publications and apps.",
    image:
  ...
  },
  {
    ...
    description:
      "Curated lifestyle and wellness placements for health, fashion, and home audiences.",
    image:
  ...
  },
  {
    ...
    title: "Sports Arena",
    description:
      "Live sports and athletic content network with high-engagement fan bases.",
    image:
  ...
  },
  {
    ...
    title: "News Daily",
    description:
      "Trusted news and current affairs inventory from top publishers worldwide.",
    image:
  ...
  },
  {
    ...
    description:
      "Streaming, movies, and entertainment content across multiple platforms.",
    image:
  ...
  },
  {
    ...
    title: "Finance Hub",
    description:
      "Financial news, markets, and investing content for professional audiences.",
    image:
  ...
  },
  {
    ...
    description:
      "Healthcare, fitness, and wellness publishers reaching health-conscious users.",
    image:
  ...
  },
  {
    ...
    title: "Auto World",
    description:
      "Automotive reviews, comparisons, and car culture destinations.",
    image:
  ...
  },
  {
    ...
    description:
      "Travel guides, destinations, and booking platforms for travel advertisers.",
    image:
  ...
  },
  {
    ...
    description:
      "Fashion, beauty, and style content from top editorial and influencer sites.",
    image:
  ...
  },
  {
    ...
    title: "Food & Drink",
    description:
      "Recipe sites, food media, and beverage content for F&B advertisers.",
    image:
...
export const mockChildSitesByBrand: Record<string, ChildSite[]> = {
  ...
  "9": [
    {
      id: "s9-1",
      name: "Travel Channel Destinations",
      image:
